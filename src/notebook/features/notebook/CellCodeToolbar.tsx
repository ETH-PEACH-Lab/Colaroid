          ...
          <li
            className={
              activeEdit === findIndex()
                ? "wrapper-button is-edit"
                : "wrapper-button"
            }
            onClick={editHandler}
            title={activeEdit === findIndex() ? "Save Edits" : "Edit"}
          >
            <i
              className={
                activeEdit === findIndex()
                  ? "codicon codicon-save-as"
        ...
        {!props.mdOnly && (
          <li className="wrapper-dropdown" title="Switch View">
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item as="button" onClick={() => props.switchStyle(0)}>
                  Diff in Context
                </Dropdown.Item>
                <Dropdown.Item as="button" onClick={() => props.switchStyle(2)}>
                  Diff Only
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
