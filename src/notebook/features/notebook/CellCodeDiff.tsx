...
export function CellCodeDiff(props: CellCodeDiffProps) {
    ...
    const editorDidMount = (editor) => {
        ...
        const lines = original_lines>modified_lines?original_lines:modified_lines;
            ...
            changes.forEach(change => {
                ...
                if (change.originalEndLineNumber === 0) {
                    ...
                    if (oChangeStart > oPrevLine) {
                        originalHiddenArea.push(new monaco.Range(oPrevLine, 1, oChangeStart, 1));
                        oLineRemain = oLineRemain - (oChangeStart - oPrevLine + 1);
                    }
                    if (mChangeStart > mPrevLine) {
                        modifiedHiddenArea.push(new monaco.Range(mPrevLine, 1, mChangeStart, 1));
